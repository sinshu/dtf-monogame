...
namespace MiswGame2008
{
    public class FastEnemy : Enemy
    {
        ...
        public FastEnemy(Game game, double x, double y)
            : base(game, x, y)
        {
            angle = 90;
            vx = vy = 0;
        ...
        public override bool Hit()
        {
            ...
            if (hitPoints == 0)
            {
                ...
                for (int i = 0; i < 8; i++)
                {
                    ...
                    Effect debris = new Debris(Game, x, y, 192, 0, 192, speed, angle);
                    Game.AddEffect(debris);
                }
                Effect effect = new BigExplosionEffect(Game, X, Y, Game.Random.Next(360), 255, 192, 255);
        ...
        public override void Draw(IGraphics graphics)
        {
            ...
            graphics.DrawObject(Image.FastEnemy, drawX, drawY, 32, 32, 0, 0, angle);
            if (damaged)
            {
