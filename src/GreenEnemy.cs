    ...
    public class GreenEnemy : Enemy
    {
        ...
        public override bool Hit()
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                Effect debris = new Debris(Game, x, y, 0, 128, 0, speed, angle);
                Game.AddEffect(debris);
            }
            Effect effect = new BigExplosionEffect(Game, X, Y, Game.Random.Next(360), 192, 255, 192);
        ...
        public override void Draw(IGraphics graphics)
        {
            ...
            graphics.DrawObject(Image.GreenEnemy, drawX, drawY, 32, 32, 0, 0, angle);
        }
